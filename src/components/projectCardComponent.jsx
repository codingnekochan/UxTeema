...
function ProjectCardComponent({
    ...
    return (
        <div
            ...
            >
                <div className='flip-card-front bg-center h-full rounded-[20px] bg-[url("/src/assets/dark.svg")] bg-no-repeat bg-cover '>
                ...
                <div className='flip-card-back bg-center h-full rounded-[20px] bg-[url("/src/assets/dark.svg")] bg-no-repeat bg-cover'>
