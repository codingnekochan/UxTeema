...
function Contact({ ...dataProps}) {
    return (
        <section id="contact" className="px-6 md:px-10 lg:px-14 xl:px-[120px] mt-[120px] md:mt-[200px] mb-24 md:mb-40 lg:mb-[110px] 2xl:mb-[150px]">
